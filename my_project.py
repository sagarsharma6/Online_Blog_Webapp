...
client = MongoClient('mongodb://abc:sagar123@ds125263.mlab.com:25263/sagar_database')
db = client['sagar_database']
...
def login():
	if request.method == 'POST':
		if request.form['username'] == 'sagar' and request.form['password'] == 'sagar123':
